...
class BotManager:
    ...
    def _load_window_nicks(self):
        """Загружает никнеймы персонажей для привязки окон."""
        try:
    ...
    def _find_game_windows(self) -> bool:
        """Находит хэндлы окон Lineage 2 в операционной системе."""
    ...
    async def activate_window(self, target="main"):
        """Выводит нужное игровое окно на передний план."""
        ...
        await asyncio.sleep(0.2) # Ожидание фокуса ввода
        return True
    ...
    def toggle_pause(self):
        """Переключатель глобальной паузы."""
        ...
        if self.bot_combat.is_paused:
            print(f"\n{'='*40}\n[ПАУЗА] Бот остановлен клавишей 'P'. Логи скрыты.\n{'='*40}\n")
        else:
